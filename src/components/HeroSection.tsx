  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-12 pb-8 text-center">
      <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-[#1a1a1a] py-2 text-sm px-2">
        <span className="rounded-full bg-violet-500/20 px-2 py-0.5 text-xs font-medium text-violet-400">v1.0 РЕЛИЗ</span>
        <span className="text-gray-300">Мониторинг, очистка и оптимизация ПК</span>
      ...
      <p className="mb-8 max-w-xl text-gray-400">
        Мониторинг CPU, RAM и GPU в реальном времени, глубокая очистка системы, игровой центр и утилиты — всё в одном премиальном приложении для Windows.
      </p>

      <div className="flex flex-col sm:flex-row items-center gap-4">
        <Button className="rounded-full bg-violet-600 px-6 hover:bg-violet-700 text-white" id="download">
          <Download className="mr-2 h-4 w-4" /> Скачать бесплатно
        </Button>
      ...
      <p className="mt-4 text-xs text-gray-600">Windows 10/11 · Бесплатно · Без рекламы</p>
    </section>
  )
}